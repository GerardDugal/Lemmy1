...
def main_menu():
    ...
    while menu:
        ...
        # Main Menu UI
        screen.blit(background, [0, 0])
        title = text_format("WOW 2.0", font, 90, darkviolet)
        if selected == "start":
...
pygame.display.set_caption("WoW 2.0") #название окна
...
BACKGROUND_COLOR = pygame.image.load('Текстуры/GererdLOX.png')
...
class Platform(Sprite):
    def __init__(self, x, y):
        ...
        self.image = load('Текстуры/world_inactive_block.png')
...
class BlockDie(Sprite):
    def __init__(self, x, y):
        ...
        self.image = image.load("Текстуры/dieBlock.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
class LieBlockDie(Sprite):
    def __init__(self, x, y):
        Sprite.__init__(self)
        Platform.__init__(self, x, y)
        self.image = image.load("Текстуры/world_inactive_block.png")
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class Dollars(Sprite):
    def __init__(self, x1, y1):
        Sprite.__init__(self)
        self.image = load('Текстуры/imgonline-com-ua-Resize-9E3FzKpwN2u.png')
        self.rect = self.image.get_rect()
        self.rect.x = x1
        self.rect.y = y1
...
class Finish(Sprite):
    def __init__(self, x, y):
        Sprite.__init__(self)
        self.image = load('Текстуры/checkered-vector-4.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    def collide(self, xvel, yvel, platforms):
